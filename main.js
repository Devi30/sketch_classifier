...
document.getElementById("user_sketch").innerHTML="Your Sketches:"+ drawn_sketch
document.getElementById("user_confidence").innerHTML="confidence:"+Math.round(results[0].confidence*100)+"%"
}
